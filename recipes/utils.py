from recipes.models import Recipe   #you need to connect parameters from recipe model
...
def get_chart(chart_type, data, **kwargs):
   ...
   if chart_type == '#1':
       ...
       plt.title("Cooking time in minutes")
       ...
       plt.plot(data['cooking_time'], data['cooking_time'])
   else:
